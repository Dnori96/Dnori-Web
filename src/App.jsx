...
function App() {
	...
	return (
		<div
			className="grid grid-rows-[auto_auto_1fr_auto_auto] grid-cols-1 pl-10 pr-10 pt-4 pb-4 h-dvh scroll-smooth bg-grey-100 dark:bg-grey-900 color-transition overflow-y-scroll"
			data-theme={theme}
		>
