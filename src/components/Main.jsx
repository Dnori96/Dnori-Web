		...
		<main className="flex flex-col justify-evenly items-center gap-20">
			<section className="flex flex-col justify-center items-center mt-50 mb-30 gap-2">
				...
				<div className="flex gap-5 mt-4">
					<a className="icons mt-3 mb-2" href="https://github.com/Dnori96" alt="Link to github" aria-label="Link to github in the form of an icon" target="blank">
					...
					<a className="icons mt-3 mb-2" href="https://www.instagram.com/diegonori96/" alt="Link to instagram" aria-label="Link to instagram in the form of an icon" target="blank">
						<img src={icon.insta} className="size-7 animate-slide-up-fade cursor-pointer" />
					</a>
				</div>
			</section>
			<section className="flex flex-col justify-center gap-10">
				<h3 id="projects" className="dark:text-grey-300 text-grey-800 resize-title-projects animate-fade-in text-center font-bold">
					{projectsTitle}
				</h3>
				<div className="grid grid-cols-1 resize-card gap-6 animate-fade-in" id="cards">
			...
			<section className="flex flex-col gap-3 h-36 mb-10 dark:text-grey-300 text-grey-800 text-center">
				<h3 id="about" className="resize-title-projects font-bold animate-fade-in">
					{about}
				</h3>
